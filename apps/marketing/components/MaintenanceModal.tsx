  ...
  return (
    <div className="fixed inset-0 z-9999 flex items-center justify-center bg-white">
      <div className="text-center px-6">
        <div className="mx-auto mb-6 flex h-48 w-48 items-center justify-center rounded-full bg-[#F5F0EB]">
          <Icon />
        </div>
        ...
        <p className="text-sm font-light text-[#666] leading-relaxed max-w-md mx-auto">
